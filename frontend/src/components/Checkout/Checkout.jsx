...
const Checkout = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      ...
      >
        <h5 className="text-white">Fizetés</h5>
      </div>
    </div>
  );
};
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      <h5 className="text-[18px] font-[500]">Cím</h5>
      <br />
      <form>
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Végösszeg:</h3>
        <h5 className="text-[18px] font-[600]">{subTotalPrice} HUF</h5>
      </div>
      <br />
